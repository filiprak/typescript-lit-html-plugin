...
describe('CompletionEntryDetails', () => {
    it('should return html details for tag completion with start-tagged template', () => {
        const server = createServer();
        openMockFile(server, mockFileName, 'const q = `<`');
        server.sendCommand('completionEntryDetails', { file: mockFileName, offset: 13, line: 1, entryNames: ['a'] });
